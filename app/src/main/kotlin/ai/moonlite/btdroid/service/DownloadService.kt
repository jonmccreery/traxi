package ai.moonlite.btdroid.service

import ai.moonlite.btdroid.BtdroidApplication
import ai.moonlite.btdroid.MainActivity
import ai.moonlite.btdroid.R
 ...
 *
 * The service does not own the download. [ai.moonlite.btdroid.session.SessionController]
...
class DownloadService : Service() {
    ...
    private fun container() =
        (applicationContext as BtdroidApplication).container
    ...
    private fun buildNotification(
        ...
        return NotificationCompat.Builder(this, BtdroidApplication.DOWNLOAD_CHANNEL_ID)
