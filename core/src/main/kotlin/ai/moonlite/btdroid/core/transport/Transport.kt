package ai.moonlite.btdroid.core.transport

/**
 * A raw, bidirectional byte stream to the logger.
 *
 * Deliberately minimal and free of Android types so that the entire protocol
 * stack above it — [ai.moonlite.btdroid.core.protocol.PmtkClient],
 * [ai.moonlite.btdroid.core.protocol.FlashDownloader] — is testable on the JVM
